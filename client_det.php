...
print_r($author);
				...
				echo '<p>Start: <input type="text"  id = "start" onblur="if (this.value === \'undefined\') {this.value=\'\'};" name = "start" class="auto-kal" data-kal="format: \'DD MMMM YYYY\'" value ="'. $dates['start'].'"/><input type = "button" value = "clear" onclick = "javascript:document.getElementById(\'start\').value = \'\';"/></p>';
                                echo '<p>1st month review: <input type="text"  id="first" onblur="if (this.value === \'undefined\') {this.value=\'\'};" name = "first" class="auto-kal" data-kal="format: \'DD MMMM YYYY\'" value ="'. $dates['first'].'" /><input type = "button" value = "clear" onclick = "javascript:document.getElementById(\'first\').value = \'\';"/></p>';
                                echo '<p>5th month review: <input type="text"  id="fifth" onblur="if (this.value === \'undefined\') {this.value=\'\'};" name = "fifth" class="auto-kal" data-kal="format: \'DD MMMM YYYY\'" value ="'. $dates['fifth'].'" /><input type = "button" value = "clear" onclick = "javascript:document.getElementById(\'fifth\').value = \'\';"/></p>';
                                echo '<p>9th month review: <input type="text"  id = "ninth" onblur="if (this.value === \'undefined\') {this.value=\'\'};" name = "ninth" class="auto-kal" data-kal="format: \'DD MMMM YYYY\'" value ="'. $dates['ninth'].'" /><input type = "button" value = "clear" onclick = "javascript:document.getElementById(\'ninth\').value = \'\';"/></p>';
                                echo '<p>Year end review: <input type="text"  id = "yearend" onblur="if (this.value === \'undefined\') {this.value=\'\'};" name = "yearend" class="auto-kal" data-kal="format: \'DD MMMM YYYY\'" value ="'. $dates['yearend'].'"  /><input type = "button" value = "clear" onclick = "javascript:document.getElementById(\'yearend\').value = \'\';"/></p>';
                                echo '<p>Agreed end of Support: <input type="text"  id = "supportend" onblur="if (this.value === \'undefined\') {this.value=\'\'};" name = "supportend" class="auto-kal" data-kal="format: \'DD MMMM YYYY\'" value ="'. $dates['supportend'].'"  /><input type = "button" value = "clear" onclick = "javascript:document.getElementById(\'supportend\').value = \'\';"/></p>';
                                echo '<p>Agreed end of Accommodation: <input type="text" id = "accomend" onblur="if (this.value === \'undefined\') {this.value=\'\'};" name = "accomend" class="auto-kal" data-kal="format: \'DD MMMM YYYY\'" value ="'. $dates['accomend'].'"  /><input type = "button" value = "clear" onclick = "javascript:document.getElementById(\'accomend\').value = \'\';"/></p>';
