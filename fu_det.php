...
//MATT WAS HERE, DON't SHOW "STAGE" ON FU SUMMARY PAGE. DO SHOW "GO BACK TO CASE" LINK.
...
//MATT WAS HERE, ADDED THIS BUTTON TO RETURN TO THE CASE
echo '<a href="case_det.php?case=' .$fu_data['id_case'] . '" class="add_lnk">Return to the case</a>';
...
echo "<br /><br /></fieldset>";
// MATT WAS HERE, REMOVING "CREATE A NEW APPOINTMENT FROM THIS FOLLOWUP BUTTON
//if (! $app) {
