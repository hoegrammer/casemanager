...
function get_person_initials($item, $with_abbver = true) {
	...
	if (function_exists("mb_substr")) {
		$ret .= $item['username'];
		$ret .= mb_substr($item['name_first'], 0, 2, "utf-8");
		$ret .= mb_substr($item['name_middle'], 0, 1, "utf-8");
		$ret .= mb_substr($item['name_last'], 0, 2, "utf-8");
	} else {
...
// MATT WAS HERE, NO SPECIAL CASES FOR "CONCLUSION" FOLLOWUPS, ETC, JUST STICK TO DISPLAYING MAIN DESCRIPTION TEXT, PLEASE
