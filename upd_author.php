...
//	print_r("!!"._session('status'));
	switch (_session('type'))
		{
		case 'user': $status='normal';break;
		case 'group': $status='normal';break;
		case 'host': $status='normal';break;

		}

	$fl .= ", status = '" . _session('status') . "'";
	if (_session('right1')=='on')
		$fl .= ", right1 = '1'";
	else
		$fl .= ", right1 = '0'";
	if (_session('right2')=='on')
		$fl .= ", right2 = '1'";
	else
		$fl .= ", right2 = '0'";
	if (_session('right3')=='on')
		$fl .= ", right3 = '1'";
	else
		$fl .= ", right3 = '0'";
	if (_session('right4')=='on')
		$fl .= ", right4 = '1'";
	else
		$fl .= ", right4 = '0'";
	if (_session('right5')=='on')
		$fl .= ", right5 = '1'";
	else
		$fl .= ", right5 = '0'";
	if (_session('right6')=='on')
		$fl .= ", right6 = '1'";
	else
		$fl .= ", right6 = '0'";
	if (_session('right7')=='on')
		$fl .= ", right7 = '1'";
	else
		$fl .= ", right7 = '0'";
	if (_session('right8')=='on')
		$fl .= ", right8 = '1'";
	else
		$fl .= ", right8 = '0'";
	if (_session('right9')=='on')
		$fl .= ", right9 = '1'";
	else
		$fl .= ", right9 = '0'";
